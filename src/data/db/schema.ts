...
// This is the frozen v1 schema (migration 1). Do NOT edit table shapes forward here —
// later columns/tables belong in MIGRATIONS so a fresh DB replays cleanly with no
